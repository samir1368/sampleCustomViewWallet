...
public class CustomWalletViewPager extends ViewPager implements ViewPager.PageTransformer {
    ...
    public CustomWalletViewPager(Context context) {
        this(context, null);
        mContext = context;
    }

    public CustomWalletViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
